...
public class LegoCollection implements Menu{
    ...
    public String displayLegoMenu(){
        ...
        do {
            ...
            System.out.println("1. Add LEGO Set(s)");
            System.out.println("2. Remove LEGO Set");
            System.out.println("3. Display All LEGO Sets");
            System.out.println("4. Update LEGO Set");
            System.out.println("5. Retrieve Total Cost of LEGO Set");
     ...
     * Parameters: none
     * @return boolean
     * Purpose: The ability to add Lego set
     * objects to a list from the command
     * line or from a file
     */
    @Override
    public boolean addSet(){
        do{
            System.out.println("How would you like to add LEGO set(s)? From file or Manually");
            Scanner option = new Scanner(System.in);
            String choiceOption = option.nextLine();
            if(choiceOption.equalsIgnoreCase("From file")){
                addFromFile();
                return true;

            }
            else if(choiceOption.equalsIgnoreCase("Manually")) {
     ...
     */
    private boolean addManually(Scanner input) {
        try {
